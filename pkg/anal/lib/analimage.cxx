...
ImageSignature::ImageSignature(){
  ...
  fPrintInfo[i++] = new PrintInfoType<double>(" 5.0 Sigma clipped mean","Mean","%9.2f",9,&fRobustMean);
  fPrintInfo[i++] = new PrintInfoType<double>(" 5.0 Sigma clipped RMS","RMS","%8.1f",8,&fRobustRMS);
  fPrintInfo[i++] = new PrintInfoType<int>(" N pixels under 5.0 Sigma","NUnder","%7d",7,&fNUnder);
  fPrintInfo[i++] = new PrintInfoType<int>(" N pixels over 5.0 Sigma","NOver","%6d",6,&fNOver);
  fPrintInfo[i++] = new PrintInfoType<int>(" Number of saturated pixels","Satu","%7d",7,&fSatu);
  fPrintInfo[i++] = new PrintInfoType<double>(" 0.99 quantile (level for continuum exposure)","Q99","%8.1f",8,&fQuant99);
  fPrintInfo[i++] = new PrintInfoType<double>(" 0.999 quantile (level for arc exposure)","Q999","%8.1f",8,&fQuant999);
  fPrintInfo[i++] = new PrintInfoType<double>(" 0.9999 quantile (level for point source)","Q9999","%8.1f",8,&fQuant9999);
  fPrintInfo[i++] = new PrintInfoType<double>(" magic focus info","Focus","%4.2f",4,&fFocus);
  fPrintInfo[i++] = new PrintInfoType<double>(" RMS of the noise","Noise","%6.2f",6,&fNoise);
